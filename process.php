...
if (isset($_POST['confirm'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO user (Fullname, Email, Password, Dob, Country, Gender) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $fullname, $email, $password, $dob, $country, $gender);
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    <head>
        ...
        <style>
            ...
            .content {
                background-color: rgb(123, 209, 133);
                border-radius: 10px;
                padding: 40px 45px;
                max-width: 450px;
                width: 100%;
