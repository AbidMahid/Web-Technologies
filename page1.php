    ...
    <div class="flex-container">
        <div style="background-color:rgb(250, 164, 167); ; height: 350px; width: 350px;">
            ...
            <form id="receptionistForm" action="Bookingprocess.php" method="post">
                ...
                <input type="submit" value="Confirm" style=" border-radius: 6px; margin-top: 10px; font: bold; font-size: 14px; color: rgb(76, 1, 1);  margin-left: 80px; padding: 4px 30px;" formaction="bookingpage.php"><br>
            </form>
