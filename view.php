...
<head>
    ...
    <style>
        ...
        .login-btn {
            background-color: rgb(154, 42, 19);
            color: white;
            border: 2px solid rgb(157, 84, 39);
        }
        ...
        .user-logout {
            ...
            top: 0;
            z-index: 100;
            background-color: rgb(40, 217, 182);
        }
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col" style="font-size: 18px; margin-left:10px;">
                ...
                <div class="buttons">
                    <form action="page.php" method="post" style="margin: 0;">
                        <button type="submit" name="room" value="deluxe_double" class="login-btn">Available now</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="col" style="font-size: 18px; margin-left:10px;">
                ...
                <div class="buttons">
                    <form action="page2.php" method="post" style="margin: 0;">
                        <button type="submit" name="room" value="deluxe_single" class="login-btn">Available now</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="col" style="font-size: 18px; margin-left:10px;">
                ...
                <div class="buttons">
                    <form action="page3.php" method="post" style="margin: 0;">
                        <button type="submit" name="room" value="family_double" class="login-btn">Available now</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="col" style="font-size: 18px; margin-left:10px;">
                ...
                <div class="buttons">
                    <form action="page4.php" method="post" style="margin: 0;">
                        <button type="submit" name="room" value="family_single" class="login-btn">Available now</button>
                    </form>
                </div>
            </div>
        </div>
